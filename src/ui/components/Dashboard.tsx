            ...
            <div className="container" style={{ padding: '1rem' }}>
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', marginBottom: '2rem' }}>
                    {paginatedReminders.map(rem => (
                        <div key={rem.id} className="glass-panel card-hover" style={{
                            padding: '1rem',
                            display: 'flex',
                            flexDirection: 'column',
                            gap: '1rem',
                            position: 'relative',
                            borderLeft: `4px solid ${rem.isPinned ? 'var(--accent-purple)' : rem.status === 'completed' ? 'var(--accent-success)' : 'var(--accent-warning)'}`,
                            opacity: rem.status === 'completed' ? 0.7 : 1
                        }}>
                            {rem.isPinned && (
                                <div style={{ position: 'absolute', top: '0.75rem', right: '0.75rem', fontSize: '1.125rem' }}>
                                    📌
                                </div>
                            )}
